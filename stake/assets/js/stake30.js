var walletAddress = null,
  ...
  contract = null,
  stakingAddress = "0x4dd9420007C9f08A619430E4f7854C264eF64202",
  contractAddress = "0xd664eaf0c6b47f446f2a83b9230c1d927ee605a9",
  isMetaMask = true,
  web3 = null,
  web3Modal = null,
  provider = null,
    ...
    function (info) {
      ...
      $(".withdrawTokensBtn").on("click", function () {
        if (Date.parse(nextWithdrawl) > Date.parse(new Date())) {
          if (
            confirm(
              "Are you sure you wish to emergency withdraw your tokens? You will be taxed 10%. Proceed with caution"
            )
          ) {
            ...
            stakingContract.methods
              ...
              .then(function (res, err) {
                if (res.status) {
                  setAlert(
                    false,
                    "Successfully emergency withdrawn 10% taxed tokens"
                  );
                  ...
                  setAlert(
                    true,
                    "Could not emergency withdraw your tokens at this time, please try again later"
                  );
                }
            ...
            stakingContract.methods
              ...
              .then(function (res, err) {
                if (res.status) {
                  setAlert(
                    false,
                    "Successfully withdrawn " + tokenAmount + " tokens"
                  );
                  ...
                  setAlert(
                    true,
                    "Could not withdraw your tokens at this time, please try again later"
                  );
                }
                withdrawLoader.hideLoader();
              })
          ...
          stakingContract.methods
            ...
            .then(function (res, err) {
              if (res.status) {
                setAlert(
                  false,
                  "Successfully claimed harvested " + pendingRewards + " tokens"
                );
                ...
                setAlert(
                  true,
                  "Could not claim your harvested rewards at this time, please try again later"
                );
              }
      ...
      contract.methods
        .allowance(walletAddress, stakingAddress)
        .call()
        .then(
          function (res, err) {
            ...
            $(".stakeBtn").on("click", function () {
              ...
              if (isApproved) {
                ...
                let correctAmount = web3.utils.toWei(tokenAmt.toString());
                stakingContract.methods
                  .deposit(correctAmount)
                  .send({ from: walletAddress })
                  .then(function (res, err) {
                    if (res.status) {
                      setAlert(
                        false,
                        "Successfully deposited " + tokenAmt + " tokens"
                      );
                      $("#tokenAmtTb").val("");
                      ...
                      setAlert(
                        true,
                        "Could not stake your tokens at this time, please try again later"
                      );
                    }
                ...
                contract.methods
                  ...
                  .then(function (res, err) {
                    if (res.status) {
                      ...
                      setAlert(
                        true,
                        "Could not approve the contract at this time, please try again later"
                      );
                      isApproved = false;
                    }
                    stakeLoader.hideLoader();
...
function setAlert(error, msg) {
  ...
  if (error) {
    elem =
      '<div class="alert danger"><span class="closebtn">&times;</span><i class="fa fa-times-circle"></i>&nbsp;&nbsp;&nbsp;' +
      msg +
      "</div>";
  } else {
    elem =
      '<div class="alert success"><span class="closebtn">&times;</span><i class="fa fa-check-circle"></i>&nbsp;&nbsp;&nbsp;' +
      msg +
      "</div>";
  }
...
function getUserInfo() {
  return new Promise(function (resolve, reject) {
    var userInfo = new Promise(function (resolve, reject) {
      stakingContract.methods.userInfo(walletAddress).call(function (err, res) {
        if (res) {
          resolve(res);
        } else {
          reject(err);
    ...
    var totalStaked = balanceOf.then(function (result) {
      return new Promise(function (resolve, reject) {
        stakingContract.methods.totalStaked().call(function (err, res) {
          if (res) {
            resolve(res);
          } else {
            reject(err);
    ...
    var apy = totalStaked.then(function (result) {
      return new Promise(function (resolve, reject) {
        stakingContract.methods.apy().call(function (err, res) {
          if (res) {
            resolve(res);
          } else {
            reject(err);
    ...
    var unlockTime = apy.then(function (result) {
      return new Promise(function (resolve, reject) {
        stakingContract.methods
          .holderUnlockTime(walletAddress)
          .call(function (err, res) {
            if (res) {
              resolve(res);
            } else {
...
var walletConnect = {
  initialise: function () {
    if (location.protocol !== "index.html") {
      alert(
        "You cannot connect your wallet unsecurely. Please revist the website using HTTPS."
      );
      return;
    }
...
var harvestedLoader = {
  showLoader: function () {
    $(".harvestRewardsBtn").html(
      '<i class="fa fa-spinner fa-spin"></i> Claiming...'
    );
  },
  hideLoader: function () {
...
var withdrawLoader = {
  showLoader: function () {
    $(".withdrawTokensBtn").html(
      '<i class="fa fa-spinner fa-spin"></i> Withdrawing...'
    );
  },
  hideLoader: function () {
    if (isEmergency) {
  ...
  return [
    ...
    },
    {
      inputs: [
        ...
        { internalType: "address", name: "send_to_wallet", type: "address" },
        { internalType: "uint256", name: "number_of_tokens", type: "uint256" },
      ],
      name: "remove_Random_Tokens",
      outputs: [{ internalType: "bool", name: "_sent", type: "bool" }],
      stateMutability: "nonpayable",
      type: "function",
    },
    {
    ...
    {
      inputs: [
        { internalType: "uint256", name: "maxTxPercent_x100", type: "uint256" },
      ],
  ...
  return [
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: "uint256", name: "accTokensPerShare", type: "uint256" },
      ],
      stateMutability: "view",
      type: "function",
    },
    ...
    {
      inputs: [{ internalType: "uint256", name: "newApy", type: "uint256" }],
      name: "updateApy",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    ...
    {
      inputs: [
        { internalType: "uint256", name: "newPenaltyPerc", type: "uint256" },
      ],
    ...
    {
      inputs: [
        { internalType: "uint256", name: "newlockDuration", type: "uint256" },
      ],
